...
export default function InternSchedulePage() {
    ...
    return (
        // Escape the layout's padding/max-width so we can own the full area
        <div className="-m-8 flex" style={{ minHeight: 'calc(100vh - 0px)' }}>

            {/* ── LEFT PANEL: Title + Tabs ── */}
            <div className="w-52 shrink-0 flex flex-col gap-5 px-6 py-8 border-r border-gray-100 bg-white">
                ...
                <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-2">
                        <h1 className="text-[22px] font-black text-gray-900 tracking-tight uppercase leading-tight">
                            My Schedule
                        </h1>
                        {loading && <RefreshCw className="w-3.5 h-3.5 text-gray-400 animate-spin shrink-0" />}
                    </div>
                </div>

                {/* View toggle — stacked below title */}
                    ...
                    <div className="mt-auto pt-4 border-t border-gray-50">
                        <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100 text-center">
                            ...
                            <p className="text-[9px] font-black uppercase tracking-widest text-gray-400 mt-0.5">
                                {schedules.length === 1 ? 'Meeting' : 'Meetings'}
                            </p>
                        </div>
                    </div>
                )}
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div className="flex items-start justify-between mb-4">
                                                        ...
                                                        {isPast && <CheckCircle2 className="w-4.5 h-4.5 text-emerald-400 shrink-0" />}
                                                    </div>
                                                    <div className="space-y-3">
                                                        ...
                                                        <a
                                                            ...
                                                            className={`w-full py-3 text-[10px] font-black uppercase tracking-widest rounded-xl transition-all flex items-center justify-center gap-2 ${isPast
