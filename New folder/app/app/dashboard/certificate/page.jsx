                        ...
                        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-8">
                            ...
                            >
                                ...
                                <div className="flex-1 overflow-y-auto p-6 md:p-10 custom-scrollbar flex flex-col lg:flex-row gap-10 bg-white relative z-10 text-left">
                                    ...
                                    <div className="flex-[2] bg-white rounded-[1.5rem] border-[12px] border-double border-gray-100 flex flex-col items-center justify-center p-16 aspect-[4/3] relative group shadow-2xl overflow-hidden text-center m-4">
                                        ...
                                        <div className="relative z-10 w-full h-full border-4 border-gray-50 p-10 flex flex-col items-center justify-between">
                                            <div className="space-y-4">
                                                <div className="flex items-center justify-center gap-3 mb-4">
                                                    <div className="w-10 h-1bg-gray-200" />
                                                    <Award className="w-12 h-12 text-black" />
                                                    <div className="w-10 h-1 bg-gray-200" />
                                                </div>
                                                <h5 className="text-[10px] font-black uppercase tracking-[0.5em] text-gray-400">Certificate of Completion</h5>
                                                <div className="h-px w-20 bg-gray-100 mx-auto" />
                                            </div>

                                            <div className="space-y-2">
                                                <p className="text-[11px] font-medium italic text-gray-400">This is to certify that the scientific protocol for</p>
                                                <h4 className="text-3xl font-black text-gray-900 uppercase tracking-tighter leading-tight drop-shadow-sm">{selectedCert.title}</h4>
                                                <p className="text-[11px] font-medium italic text-gray-400">has been successfully deployed and verified.</p>
                                            </div>

                                            <div className="w-full flex justify-between items-end px-4 mt-8">
                                                <div className="text-left">
                                                    <div className="w-24 h-px bg-gray-200 mb-2" />
                                                    <p className="text-[8px] font-black uppercase tracking-widest text-gray-400">ISSUED DATE: {selectedCert.issuedDate}</p>
                                                </div>
                                                <div className="w-16 h-16 rounded-full border-4 border-emerald-50/50 flex items-center justify-center relative">
                                                ...
                                                <div className="text-right">
                                                    <div className="w-24 h-px bg-gray-200 mb-2" />
                                                    <p className="text-[8px] font-black uppercase tracking-widest text-gray-400">AUTH: {selectedCert.issuer}</p>
                                                </div>
                                            </div>
                                        </div>

                                        <div className="absolute top-6 left-6 px-3 py-1.5 bg-gray-100 text-gray-400 rounded-xl text-[9px] font-black uppercase tracking-widest border border-gray-200 shadow-sm opacity-50 z-20">DOCUMENT PREVIEW</div>
                                    </div>
